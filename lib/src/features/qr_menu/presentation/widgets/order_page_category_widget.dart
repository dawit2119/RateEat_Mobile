...
class OrderPageCategoryWidget extends StatefulWidget {
  final QRCategory category;
  final List<QRItem> items;
  final bool isSelected;
  final Function selector;
  const OrderPageCategoryWidget(
      {super.key,
  ...
  State<StatefulWidget> createState() {
    return _OrderPageCategoryWidgetState();
  }
}

class _OrderPageCategoryWidgetState extends State<OrderPageCategoryWidget> {
  @override
