...
class EditQROrderItemCard extends StatefulWidget {
  final QRItem item;
  final Restaurant? restaurant;
  final String currencyCode;

  const EditQROrderItemCard({
    super.key,
    required this.item,
    this.restaurant,
  ...
  @override
  State<EditQROrderItemCard> createState() {
    return EditQROrderItemCardState();
  }
}

class EditQROrderItemCardState extends State<EditQROrderItemCard> {
