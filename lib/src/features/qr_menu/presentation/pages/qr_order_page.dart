...
class QROrderPage extends StatefulWidget {
  ...
  const QROrderPage({super.key, required this.restaurantId});

  @override
  State<StatefulWidget> createState() {
    return QROrderPageState();
  }
}

class QROrderPageState extends State<QROrderPage> {
                                ...
                                children: [
                                  ...(state is QRMenuLoaded
                                    ...
                                    (category) {
                                      ...
                                      return OrderPageCategoryWidget(
                                        category: category,
        ...
        bottomNavigationBar: IntrinsicHeight(
          child: Container(
            ...
            child: OrderButton(
              ...
              onTap: () {
                if (context.read<QROrderBloc>().state.items.isNotEmpty) {
                  context.pushNamed(
                    AppRoutes.qrOrderSummery,
                    pathParameters: {
                      'restaurantId': widget.restaurantId,
                    },
                    extra: {
