...
class EditQROrderPage extends StatefulWidget {
  final String restaurantId;
  final String orderId;

  const EditQROrderPage(
      {super.key, required this.restaurantId, required this.orderId});

  @override
  State<StatefulWidget> createState() {
    return EditQROrderPageState();
  }
}

class EditQROrderPageState extends State<EditQROrderPage> {
  ...
  void initState() {
    ...
    context
        ...
        .add(GetPreviousOrder(orderId: widget.orderId));
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: BlocBuilder<EditQROrderBloc, EditQROrderState>(
              builder: (context, state) {
            if (state is GetPreviousQROrderFailed) {
              return Column(
                children: [
                  SizedBox(
                    height: 30.w,
                  ...
                  ErrorAndInfoDisplayWidget(
                      ...
                      description: "Failed to load the order",
                      onPressed: () {
                        context
                            .read<EditQROrderBloc>()
                            .add(GetPreviousOrder(orderId: widget.orderId));
            ...
            } else if (state is GetPreviousQROrderLoading) {
              return SizedBox(
                height: 70.h,
                child: Column(
                    ...
                    children: [
                      ...
                      LoadingAnimationWidget.dotsTriangle(
                          color: AppColors.primaryColor, size: 7.h),
                ...
                children: [
                  ...
                  BlocListener<QRMenuBloc, QRMenuState>(
                    ...
                    child: BlocBuilder<QRMenuBloc, QRMenuState>(
                                    ...
                                    children: [
                                      ...(state is QRMenuLoaded
                                        ...
                                        (category) {
                                          ...
                                          return EditOrderPageCategoryWidget(
                                            category: category,
                                            items: (state is QRMenuLoaded
                                                    ? state.menu.items
                                                    : (state
                                                            as QRMenuNextLoading)
                                                        .menu
                                                        .items)[category] ??
                                                [],
                                            isSelected:
                      ...
                      } else if (state is QRMenuLoading ||
                          state is QRMenuInitial) {
                        return SizedBox(
                          height: 80.h,
                          width: 100.w,
                          child: Column(
        ...
        bottomNavigationBar: IntrinsicHeight(
          child: Container(
            ...
            child: OrderButton(
              ...
              onTap: () {
                if (context.read<EditQROrderBloc>().state.items.isNotEmpty) {
                  context.pushNamed(
                    AppRoutes.editQROrderSummery,
                    pathParameters: {
                      'restaurantId': widget.restaurantId,
                    ...
                    extra: {
                      "restaurant":
                          (context.read<QRMenuBloc>().state as QRMenuLoaded)
                              .menu
                              .restaurant
                    },
                  );
                  ...
                  showCustomToast(
                    context: context,
                    toastMessage: "Please select items to place order",
