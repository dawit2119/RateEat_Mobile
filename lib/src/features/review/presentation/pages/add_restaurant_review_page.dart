...
class AddRestaurantReviewPage extends StatefulWidget {
  ...
  @override
  AddRestaurantReviewPageState createState() => AddRestaurantReviewPageState();
}

class AddRestaurantReviewPageState extends State<AddRestaurantReviewPage> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    BlocListener<AddRestaurantReviewBloc,
                        AddRestaurantReviewState>(
                      listener: (context, state) {
                        if (state is AddRestaurantReviewSuccess) {
                          showCustomToast(
                            context: context,
                            toastMessage:
                                "${AppLocalizations.of(context)!.restaurantText} ${state.message}",
                        ...
                        } else if (state is AddRestaurantReviewFailure) {
                          showCustomToast(
                            context: context,
                            toastMessage:
                                "${AppLocalizations.of(context)!.restaurantText} ${state.message}",
                      ...
                      child: Padding(
                        ...
                        child: BlocBuilder<AddRestaurantReviewBloc,
                            AddRestaurantReviewState>(
                          builder: (context, state) {
                            if (state is AddRestaurantReviewLoading) {
                              ...
                              return SubmitButton(
                                ...
                                color: AppColors.primaryButtonColor,
                                onClick: () {
                                  context.read<AddRestaurantReviewBloc>().add(
