...
class EditRestaurantReviewPage extends StatefulWidget {
  ...
  const EditRestaurantReviewPage(
      {super.key,
  ...
  @override
  EditRestaurantReviewPageState createState() =>
      EditRestaurantReviewPageState();
}

class EditRestaurantReviewPageState extends State<EditRestaurantReviewPage> {
  double? rating;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => dpLocator<EditRestaurantReviewBloc>(),
      child: Scaffold(
        appBar: CustomAppBar(
            onTap: () {
              context.pop();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  BlocListener<EditRestaurantReviewBloc,
                      EditRestaurantReviewState>(
                    listener: (context, state) {
                      if (state is EditRestaurantReviewSuccess) {
                        ...
                        //* Change the page number to start from 1

                        //* Clear The Comment area
                      } else if (state is EditRestaurantReviewFailure) {
                        showCustomToast(
                          context: context,
                          toastMessage: "Restaurant ${state.message}",
                          toastType: ToastType.error,
                    ...
                    child: Padding(
                      ...
                      child: BlocBuilder<EditRestaurantReviewBloc,
                          EditRestaurantReviewState>(
                        builder: (context, state) {
                          if (state is EditRestaurantReviewLoading) {
                            ...
                            return SubmitButton(
                              ...
                              color: AppColors.primaryButtonColor,
                              onClick: () {
                                context.read<EditRestaurantReviewBloc>().add(
