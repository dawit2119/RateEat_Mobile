...
class _VerifyPhonePageState extends State<VerifyPhonePage> {
  ...
  @override
  void initState() {
    _phone = widget.user['phone_number'];
    super.initState();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "${_phone.substring(0, 4)} ${_phone.substring(4, 7)} ${_phone.substring(7, 10)} ${_phone.substring(10)}",
                  style: GoogleFonts.poppins(
                    fontSize: 1.9.h,
                    color: Colors.black,
                    fontWeight: FontWeight.bold,
                          ...
                          BlocBuilder<AuthenticationBloc, AuthenticationState>(
                            builder: (context, state) {
                              return TextButton(
                                ...
                                onPressed: ((state is SendEditPhoneOtpState &&
                                            state.status ==
                                                AuthStatus.loading) ||
                                        !enableResend)
                                    ? null
