...
void main() {
  ...
  late GetPriceSortedItemsUseCase gePriceSortedItemsUseCase;

  setUp(() {
    mockItemResultRepository = MockItemResultRepository();
    gePriceSortedItemsUseCase = GetPriceSortedItemsUseCase(
  ...
  test("Should return closest items", () async {
    ...
    //arrange
    when(mockItemResultRepository.getPriceSortedItems(
    ...
    //act
    final result = await gePriceSortedItemsUseCase(itemsFilterParams);
    ...
    verify(
      mockItemResultRepository.getPriceSortedItems(
        filterResultParams: itemsFilterParams,
        page: 1,
        limit: 10,
        latitude: 9.03,
