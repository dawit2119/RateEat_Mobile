...
void main() {
  ...
  late GetMostPopularItemsUseCase getMostPopularItemsUseCase;

  setUp(() {
    mockItemResultRepository = MockItemResultRepository();
    getMostPopularItemsUseCase = GetMostPopularItemsUseCase(
  ...
  test("Should return closest items", () async {
    ...
    //arrange
    when(mockItemResultRepository.getMostPopularItems(
    ...
    //act
    final result = await getMostPopularItemsUseCase(itemsFilterParams);
    ...
    verify(
      mockItemResultRepository.getMostPopularItems(
        filterResultParams: itemsFilterParams,
        page: 1,
        limit: 10,
        latitude: 9.03,
