...
void main() {
  ...
  setUp(() {
    ...
    getMostPopularRestaurantsUseCase = GetMostPopularRestaurantsUseCase(
  ...
  test("Should return closest items", () async {
    ...
    //arrange
    when(mockRestaurantResultRepository.getMostPopularRestaurants(
    ...
    //act
    final result =
        await getMostPopularRestaurantsUseCase(restaurantsFilterParams);
    ...
    verify(
      mockRestaurantResultRepository.getMostPopularRestaurants(
        filterResultParams: restaurantsFilterParams,
        page: 1,
        limit: 10,
      ),
